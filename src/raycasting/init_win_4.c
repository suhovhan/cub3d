...
{
	address->img[1].img = mlx_get_data_addr(address->game->no, &address->img[1].bpp, \
	&address->img[1].size_line, &address->img[1].endian);
	address->img[2].img = mlx_get_data_addr(address->game->so, &address->img[2].bpp, \
	&address->img[2].size_line, &address->img[2].endian);
	address->img[3].img = mlx_get_data_addr(address->game->ea, &address->img[3].bpp, \
	&address->img[3].size_line, &address->img[3].endian);
	address->img[4].img = mlx_get_data_addr(address->game->we, &address->img[4].bpp, \
